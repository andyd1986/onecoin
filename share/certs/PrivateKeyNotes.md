...
unlocked to sign the Onecoin-Qt.app bundle.
...
allowing somebody to distribute a Onecoin-Qt.app or onecoin-qt-setup.exe with a valid
...
that the onecoin-qt.exe file inside the installer had not been tampered with.
