...
These are the dependencies currently used by Onecoin. You can find instructions for installing them in the `build-*.md` file for your platform.
...
Telegram - https://t.me/onecoinnl
Keybase  - https://keybase.io/team/onecoin/
