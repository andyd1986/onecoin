...
const char* BIP71_MIMETYPE_PAYMENT = "application/onecoin-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/onecoin-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/onecoin-paymentrequest";
    ...
    optionsModel(0)
{
    ...
    // on Mac: sent when you click onecoin: links
...
//
// OSX-specific way of handling onecoin: URIs and PaymentRequest mime types.
...
void PaymentServer::initNetManager()
{
    ...
    // netManager is used to fetch paymentrequests given in onecoin: URIs
