...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s onecoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  onecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded onecoin transaction") + "\n" +
              "  onecoin-tx [options] -create [commands]   " + _("Create hex-encoded onecoin transaction") + "\n" +
              "\n";
