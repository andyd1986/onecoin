...
const char * const BITCOIN_CONF_FILENAME = "onecoin.conf";
const char * const BITCOIN_PID_FILENAME = "onecoind.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Onecoin";
#else
    // Unix
